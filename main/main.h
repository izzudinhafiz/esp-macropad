...
void hardwareInit(void)
{
	...
	adc1_config_channel_atten(ADC1_CHANNEL_4, ADC_ATTEN_DB_11); //Full scale 2.6V (Input scaling=0.718) need to change to input scaling 0.5 (11K + 11K)
